// import { Calendar, Edit, Mail, MapPin, Phone, PlusCircle, User, X } from 'lucide-react-native';
...
// const StudentDetailsModal = ({ isVisible, onClose, studentId }) => {
...
//   const renderFeeStatus = (feeRecord) => {
//     const statusColors = {
//       'paid': colors.success,
...
//           </Text>
//         </View>
//         <View style={styles.feeStatusDetails}>
//           <Text style={styles.feeDetailText}>
//             Next Payment: {feeRecord.nextPaymentDate}
//           </Text>
//         </View>
//         <View style={styles.feeStatusDetails}>
//           <Text style={styles.feeDetailText}>
//             Due Date: {feeRecord.dueDate}
//           </Text>
//         </View>
//       </Animated.View>
//     );
...
//           >
//             <Image
//               source={{ uri: studentData.profileImage || 'default_image_url' }}
...
//               <InfoItem 
//                 key={"admissionNumber"}
//                 icon={<User color={colors.accent} size={24} />} 
//                 label="Admission Number" 
//                 value={studentData.admissionNumber} 
//               />
//               <InfoItem
//                 key={"dateOfBirth"}
//                 icon={<Calendar color={colors.accent} size={24} />} 
//                 label="Date of Birth" 
//                 value={studentData.dateOfBirth ? new Date(studentData.dateOfBirth).toLocaleDateString() : 'N/A'} 
//               />
//               <InfoItem
//               key={'contact'}
//                 icon={<Phone color={colors.accent} size={24} />} 
//                 label="Contact" 
//                 value={studentData.contactNumber} 
//               />
//               <InfoItem 
//                 key={'email'}
//                 icon={<Mail color={colors.accent} size={24} />} 
//                 label="Email" 
//                 value={studentData.email} 
//               />
//               <InfoItem 
//                 key={'address'}
//                 icon={<MapPin color={colors.accent} size={24} />} 
//                 label="Address" 
...
//               <Text style={styles.feeSectionTitle}>Fee Details</Text>
//               {feeData?.map((feeRecord) => renderFeeStatus(feeRecord))}
//             </View>

//             {/* Action Buttons */}
//             <View style={styles.actionButtonContainer}>
//               <TouchableOpacity style={styles.actionButton} onPress={() => setShowFeeRecordModal(true)}>
//                 <PlusCircle color="white" size={20} />
//                 <Text style={styles.actionButtonText}>Add Fee Record</Text>
//               </TouchableOpacity>
//               <TouchableOpacity style={styles.actionButton} onPress={() => setShowClassChangeModal(true)}>
        ...
        return (
          <View style={styles.tabContent}>
            {feeData && feeData.length > 0 ? (
              feeData.map((feeRecord, index) => renderFeeStatus(feeRecord))
            ) : (
